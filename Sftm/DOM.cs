    ...
    public static class DOM
    {
        ...
        public static IEnumerable<Node> DomToTree(IDocument doc)
        {
            ...
            Node Copy(IElement el, IParentNode parent, Node parentNode, Node leftSibling, string partialXPath)
            {
                ...
                // I added this to build my own signature format
                // for clarity of my testing purposes
                var NodeSignature = tokenizedNode.ToDelimitedString(",").ToUpper();
                ...
                var node = new Node
                {
                    ...
                    // added to build my own signature structure
            ...
            // I have changed this line to start with the HTML tag as the root node
            // Original line of the code was: Copy(doc.Body, null, null, null, "");
            Copy(doc.DocumentElement, null, null, null, "");
